...
namespace DigitalRuby.PyroParticles
{
    ...
    public class FireBaseScript : MonoBehaviour
    {
        ...
        [Tooltip("Damage for person, 0 dor none.")]
        public float damage;
        ...
        protected virtual void Start()
        {
            ...
            CreateExplosion(gameObject.transform.position, ForceRadius, ForceAmount, damage);
        ...
        public static void CreateExplosion(Vector3 pos, float radius, float force, float damage)
        {
            ...
            foreach (Collider h in objects)
            {
                ...
                if (r != null)
                {
                    ...
                    if (r.tag=="Player" )
                    {
                        targets.Add (r.GetComponentInParent<PlayerList>());
                    }
                    else 
                        if (r.tag == "ActiveObject")
                        {
                        targets.Add(r.GetComponentInParent<ObjectList>());
                    }
                }
            }
